  ...
  return (
    <div className='body'>
      ...
      <div className='iconos'>
        ...
        <div className='call'>
          <a href='tel:+543816079212' target="_blank">
            <img src={call} alt='call' />
          </a>
        </div>
        <div className='email'>
          <a href='matiasprietohernan@gmail.com' target="_blank">
            <img src={email} alt='email' />
          </a>
        </div>
        <div className='whats'>
          <a href='https://wa.me/3816079212' target="_blank">
            <img src={whats} alt='whats' />
          </a>
        </div>
        <div className='ig'>
          <a href='https://www.instagram.com/mattiprieto00' target="_blank" rel="noopener noreferrer">
            <img src={ig} alt='ig' />
          </a>
        </div>
      </div>
